...
document.addEventListener("DOMContentLoaded", function () {
  ...
  navLinks.forEach((link) => {
    ...
    const navTitleText = navTitleElement.textContent.trim();
    const formattedEventTitle = navTitleText.replace(/\s+/g, "+");
    link.href = `/events?event-types=${formattedEventTitle + "linkhandling"}`;
  });
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  navLinks.forEach((link) => {
    ...
    const formattedNavName = menuNavLinkNameText
      .toLowerCase()
      .replace(/\s+/g, "-");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  navLinks.forEach((link) => {
    ...
    const formattedSliderName = menuSliderLinkNameText
      .toLowerCase()
      .replace(/\s+/g, "-");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  navLinks.forEach((link) => {
    ...
    const formattedName = menuFooterLinkNameText
      .toLowerCase()
      .replace(/\s+/g, "-");
