...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Go through the list and remove any events that have a start date that matches their exclude-date
  var finalEvents = Array.from(eventList.querySelectorAll(".event-item"));
  finalEvents.forEach(function (event) {
    ...
    if (excludeDate && startDate.isSame(excludeDate)) {
      event.remove();
    }
  });
});
